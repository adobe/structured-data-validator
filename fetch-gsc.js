...
(async () => {
    const secrets = JSON.parse(await readFile(join(__dirname, 'client_secret_658166152161-0gpfcghtl8neev44bfq3ku7kf660ssc4.apps.googleusercontent.com.json'), 'utf8'));
    ...
    if (!fs.existsSync('auth.json')) {
        ...
        // Example usage
        const urlToInspect = 'https://www.aemshop.net/structured-data/breadcrumb/invalid5';
